    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (("".equals(nome)) || ("".equals(login)) || ("".equals(senha))){
                out.println("<p>Informe todos os dados do cadastro.</p>");
            ...
            //request.setAttribute("lista", usuariosCadastrados);
            //request.getSession().setAttribute("lista", usuariosCadastrados);
            
            out.println("<a href=\"PortalServlet\">Continuar</a>");
            }
            out.println("</body>");
            out.println("</html>");
        }
